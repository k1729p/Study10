...
<H3>Research the <a href="https://spring.io/projects/spring-cloud-netflix">Spring Cloud Netflix</a></H3>

<p><IMG src="images/Diagram.png" height="200" width="600"/><BR>
...
The Eureka server uses a <a href="https://resilience4j.readme.io/docs">Resilience4J</a> circuit breaker.<br>
The SpringBoot applications have <a href="https://docs.spring.io/spring-boot/docs/current/reference/html/actuator.html">Spring Boot Actuator<a> enabled.
</p>
...
<li><a href="#FOUR"><b>Spring Boot Actuator</b></a></li>
<li><a href="#FIVE"><b>Other Test Scenarios</b></a></li>
</OL>
</p>
...
<img src="images/aquaSquare.png"> module 'producer' application sources:
		<a href="https://github.com/k1729p/Study10/tree/master/microservices-producer/src/main/java/kp/producer/">kp.producer</a><BR/>
<img src="images/aquaSquare.png"> module 'producer' test sources:
		<a href="https://github.com/k1729p/Study10/tree/main/microservices-producer/src/test/java/kp/producer/controller">kp.producer.controller</a><BR/>
<img src="images/aquaSquare.png"> module 'consumer' application sources:
		<a href="https://github.com/k1729p/Study10/tree/master/microservices-consumer/src/main/java/kp/consumer/">kp.consumer</a><BR/>
<img src="images/aquaSquare.png"> module 'consumer' test sources:
		<a href="https://github.com/k1729p/Study10/tree/main/microservices-consumer/src/test/java/kp/consumer/controller">kp.consumer.controller</a><BR/>
<img src="images/aquaSquare.png"> module 'registration' application sources:
...
<img src="images/yellowSquare.png">
    ...
    <a href="http://htmlpreview.github.io/?https://github.com/k1729p/Study10/blob/main/docs/testapidocs/index.html">
...
<img src="images/orangeSquare.png"><img src="images/spacer-32.png">It registers the 1st instance of <B>producer-service</B>.<br>
...
<img src="images/orangeSquare.png"><img src="images/spacer-32.png">It registers the 2nd instance of <B>producer-service</B>.<br>
...
1.1. Application tests for the consumer server and the producer server use <b>MockMvc</b>.
</p>

<p><img src="images/greenCircle.png">
1.2. In the <a href="https://github.com/k1729p/Study10/blob/main/microservices-consumer/src/main/java/kp/consumer/ConsumerApplication.java">
ConsumerApplication</a> the  web client 'RestTemplate' is configured to use a 'LoadBalancerClient'.
</p>
 
<p><img src="images/greenCircle.png">
1.3. The screenshots from the <a href="http://localhost:8761/">Eureka Dashboard</a>.
</p>
<p><IMG src="images/EurekaDashboardFragment.png" height="180" width="1050"/><BR>
<img src="images/blackArrowUp.png">
<I>Screenshot fragment from the Eureka Dashboard home</I>
</p>
<p><IMG src="images/EurekaDashboardNewlyRegisteredLeases.png" height="210" width="585"/><BR>
<img src="images/blackArrowUp.png">
<I>Screenshot fragment from the Eureka Dashboard 'registered leases' tab</I>
</P>

<p><img src="images/greenCircle.png">
1.4. The <b>registration server</b> console log 
<a href="images/ConsoleLogRegistrationServer.png">screenshot</a>.
</p>

<p><img src="images/greenCircle.png">
1.5. The Eureka server endpoint with the list of registered applications: 
...
<P>Action:<br>
<img src="images/orangeHR-500.png"><br>
<img src="images/orangeSquare.png"> 1. In the web browser call <B>consumer-service</B> two times.
...
<a href="https://github.com/k1729p/Study10/blob/main/microservices-consumer/src/main/java/kp/consumer/controller/ConsumerController.java#L35">
...
<a href="https://github.com/k1729p/Study10/blob/main/microservices-consumer/src/main/java/kp/consumer/service/ConsumerService.java#L46">
kp.consumer.service.ConsumerService::getContent</a>.
</p>
<p>
The <b>producer-service</b> controller GET method: 
<a href="https://github.com/k1729p/Study10/blob/main/microservices-producer/src/main/java/kp/producer/controller/ProducerController.java#L33">
...
<IMG src="images/ConsumerServiceContent.png" height="55" width="135"/><br>
<img src="images/blackArrowUp.png">
<I>The result from the <b>consumer-service</b></I>
</P>

<P>The <b>consumer-service</b> was called two times.<br>
<IMG src="images/ConsoleLogConsumerServer.png" height="35" width="645"/><BR>
<img src="images/blackArrowUp.png">
...
<IMG src="images/ConsoleLogProducerServer9091.png" height="25" width="645"/><BR>
<img src="images/blackArrowUp.png">
...
<IMG src="images/ConsoleLogProducerServer8081.png" height="25" width="645"/><BR>
<img src="images/blackArrowUp.png">
...
<P>Action:<br>
<img src="images/orangeHR-500.png"><br>
<img src="images/orangeSquare.png"> 1. Execute the batch file 
...
<a href="#top">Back to the top of the page</a>
<hr/>
<h3 id="FOUR">❹ Spring Boot Actuator</h3>
<p>
The <a href="https://docs.spring.io/spring-boot/docs/current/reference/html/actuator.html">Spring Boot Actuator<a> 
creates the endpoints for monitoring and managing the application.<br>
</p>

<p><img src="images/greenCircle.png">
4.1. The <a href="images/ScreenshotListOfActuatorEndpoints8081.png">
<b>screenshot</b></a> with the list of actuator endpoints. 
The result from the link '<a href="http://localhost:8081/actuator">http://localhost:8081/actuator</a>'.
</p>
<p><img src="images/greenCircle.png">
4.2. The <a href="images/ScreenshotListOfActuatorEndpoints8082.png">
<b>screenshot</b></a> with the list of actuator endpoints. 
The result from the link '<a href="http://localhost:8082/actuator">http://localhost:8082/actuator</a>'.
</p>
<p><img src="images/greenCircle.png">
4.3. The <a href="images/ScreenshotListOfActuatorEndpoints8761.png">
<b>screenshot</b></a> with the list of actuator endpoints. 
The result from the link '<a href="http://localhost:8761/actuator">http://localhost:8761/actuator</a>'.
</p>

<a href="#top">Back to the top of the page</a>
<hr/>
<h3 id="FIVE">❺ Other Test Scenarios</h3>

<p>Action:<br>
<img src="images/orangeHR-500.png"><br>
<img src="images/orangeSquare.png"> 5.1. Start the Eureka registration server.<br>
<img src="images/orangeSquare.png"> 5.2. Start <B>producer-service</B> server on default port 8081.<br>
<img src="images/orangeSquare.png"> 5.3. Start <B>consumer-service</B> server.<br>
<img src="images/orangeSquare.png"> 5.4. Execute <I>"06 CURL read.bat"</I>.<br>
<img src="images/orangeSquare.png"> 5.5. Kill the <B>producer-service</B> on default port 8081.<br>
<img src="images/orangeSquare.png"> 5.6. Start <B>producer-service</B>' server on alternative port 9091.<br>
<img src="images/orangeSquare.png"> 5.7. Execute <I>"06 CURL read.bat"</I>.<br>
<img src="images/orangeHR-500.png">
</p>

<p><img src="images/greenCircle.png">
5.1. The <B>consumer-service</B> server switches to the next available <B>producer-service</B> server.<br>
</p>
<p><img src="images/greenCircle.png">
5.2. For the absent <B>producer-service</B> there is a response "fallback" from the Resilience4J fallback method.<br>
</p>

<P><IMG src="images/ConsoleLogConsumerServerFallback.png" height="35" width="695"/><BR>
<img src="images/blackArrowUp.png">
