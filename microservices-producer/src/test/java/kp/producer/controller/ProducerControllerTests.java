...
/**
 * The {@link ProducerController} tests using the {@link MockMvc}.
 *
 */
...
class ProducerControllerTests {
	...
	private static final String CONTENT_TEXT_PAT = "[A-Z]";
	...
	void shouldGetContent() throws Exception {
		...
		resultActions.andExpect(jsonPath("$.text").value(MatchesPattern.matchesPattern(CONTENT_TEXT_PAT)));
	}
